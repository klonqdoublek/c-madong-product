export function TaskCardSkeleton() {
  return (
    <div className="rounded-xl border border-black/5 bg-cu-warm-cream px-3 py-4 animate-pulse">
      <div className="flex gap-2">
        <div className="w-[3px] shrink-0 self-stretch rounded-full bg-primary/20" />
      ...
      <div className="mt-3 h-10 w-full rounded-full bg-primary/15" />
    </div>
  );
}
