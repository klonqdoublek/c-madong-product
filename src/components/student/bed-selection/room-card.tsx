...
export function RoomCard({ room, selectingBedId, onSelectBed }: RoomCardProps) {
  return (
    <div
      className={cn(
        "rounded-[5px] border border-[rgba(88,88,86,0.24)] px-2 py-1.5",
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {room.isFull ? (
          <span className="text-[10px] font-bold text-[#dd598b]">เต็ม</span>
        ) : (
          <span className="text-[10px] font-bold text-[#52ad7e]">
